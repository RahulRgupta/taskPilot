...
export class RegisterOrganizationDto {
  ...
  @ApiProperty({ example: 'admin@acme.com', description: 'Organization email (used for login)' })
  @IsNotEmpty({ message: 'Email is required' })
  @IsEmail({}, { message: 'Please enter a valid email' })
  email: string;

  @ApiProperty({ example: 'password123', minLength: 6, description: 'Password for login (min 6 characters)' })
