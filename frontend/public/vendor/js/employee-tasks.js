...
$(function () {
  ...
  function buildCard(task) {
    var assigneeName = task.assignedTo?.name || task.assignedTo?.email || "";
    var initials = getInitials(assigneeName);
    var bg = getAvatarColor(assigneeName);
    var dateBadges = "";
    if (task.assignDate) {
      ...
      '<div class="kanban-card" data-task-id="' + task.id + '">' +
        ...
        '<div class="card-meta">' +
          '<div class="d-flex align-items-center gap-2">' +
            ...
            '<span>' + $("<span>").text(assigneeName || "—").html() + "</span>" +
          "</div>" +
